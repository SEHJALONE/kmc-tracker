...
// Daily Activities Log — a supervisor's own record of where each bus was
...
// it handy.
export default function DailyActivitiesLog({ onBack, theme = 'dark', currentUserName = null }) {
    ...
    <div style={{ minHeight: '100vh', background: bg, fontFamily: fm, color: text, padding: 'clamp(20px,4vw,36px) clamp(14px,4vw,32px)' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', padding: '0 24px', gap: 14 }}>
          ...
          <div>
            <div style={{ fontSize: 20, fontWeight: 800, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#fff' }}>Daily Activities Log</div>
            <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.5)', letterSpacing: '0.08em', marginTop: 2 }}>Your own record of bus positions — a proofing check against Travel Card</div>
          </div>
